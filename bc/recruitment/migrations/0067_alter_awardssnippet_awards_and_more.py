...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "recruitment",
            "0066_directory_search_block__add_bucks_online_directory_option",
        ),
    ]

    operations = [
        migrations.AlterField(
            model_name="awardssnippet",
            name="awards",
        ...
        migrations.AlterField(
            model_name="jobplatformsmediasnippet",
            name="job_platforms",
            field=wagtail.fields.StreamField(
                [("platform", 3)],
                block_lookup={
                    0: (
                        "wagtail.blocks.CharBlock",
                        (),
                        {"form_classname": "title", "icon": "title", "label": "Name"},
                    ),
                    1: (
