...
class JobCategory(models.Model):
    ...
    @staticmethod
    def get_school_and_early_years_slugs():
        return list(
    ...
    @staticmethod
    def schools_and_early_years_count(queryset=None):
        if not queryset:
            queryset = TalentLinkJob.objects.all()
        return queryset.filter(
            subcategory__categories__slug__in=JobCategory.get_school_and_early_years_slugs()
        ).count()
