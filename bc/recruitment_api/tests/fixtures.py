...
advertisement = {
        ...
        "configurableField": [
            {
                ...
                "criteria": {
                    "criterion": [
                        {"label": "Enter here", "value": "31/01/2020", "activators": []}
                    ]
                },
            },
            {
            ...
            },
            {
                ...
                "criteria": {
                    "criterion": [
                        {"label": "Enter here", "value": "15/01/2020", "activators": []}
                    ]
                },
            },
            {
            ...
            },
            {
                ...
                "criteria": {
                    "criterion": [
                        {"label": "Surname", "value": "Richardson", "activators": []},
        ...
        "customField": [
            {
                "label": "Overview",
                "order": 1,
                "value": "<p>Required for 24th February 2020 (or as close to as possible)</p>\n<p>Salary: Bucks Pay Range 3 Scale 16 - 20</p>\n<p>Full Time 08:15 – 15:45 Term Time Only (+5 INSET Days)</p>\n<p><strong>Are you a dynamic and compassionate practitioner with the capacity to grow and develop within a growing team? </strong></p>\n<p><strong>We are looking for a Higher-Level Teaching Assistant with experience of teaching whole classes in the Early Years Foundation Stage.</strong></p>\n<p>In joining Elmhurst School and the Great Learners Trust you will benefit from being a part of a dynamic and forward-thinking Multi-Academy Trust.</p>",  # noqa
            },
            {
                "label": "About us",
                "order": 2,
    ...
    "customLovs": {
        "customLov": [
            ...
            },
            {
                ...
                "criteria": {
                    "criterion": [
                        {"label": "Aylesbury", "value": "Aylesbury", "activators": []}
                    ]
                },
            },
            {
            ...
            },
            {
                ...
                "criteria": {
                    "criterion": [
                        {"label": "Full Time", "value": "Full Time", "activators": []}
                    ]
                },
            },
        ]
    ...
    "id": 164579,
    "jobNumber": "FS11605",
    "jobTitle": "Higher Level Teaching Assistant - Elmhurst School ",
    "keyword": None,
    "language": "UK",
    "location": None,
    "operationals": None,
