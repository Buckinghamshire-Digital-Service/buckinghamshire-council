    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('redirect_to', models.URLField(blank=True, help_text='Entering a URL here will prevent the page from being visited, and will instead redirect the user.', verbose_name='Redirect to external URL')),
                ('show_live_chat_client', models.BooleanField(default=False, help_text='Show live chat support client on this page')),
                ...
                ('hero_image', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='images.CustomImage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='useful_links', to='family_information.FamilyInformationHomePage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
